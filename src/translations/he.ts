export const heTranslations = {
  ...
  aboutSectionSubtitle: "רופאה בכירה ומוערכת המתמחה באונקולוגיה קלינית וטיפול מותאם אישית בסרטן",
  aboutSectionText1: "ד\"ר ויקטוריה ניימן היא מומחית מובילה באונקולוגיה קלינית, רפואה פנימית ורדיותרפיה, עם ניסיון של למעלה מ-30 שנה. היא מנהלת את מחלקת האשפוז האונקולוגי במרכז דוידוף לסרטן שבמרכז הרפואי רבין.",
  aboutSectionText2: "התמחותה מתמקדת בגידולים אורו-אונקולוגיים, כולל סרטן כליה, ערמונית, שלפוחית השתן ואשכים, וכן בסרטן השד. ד\"ר ניימן פעילה במחקרים קליניים בינלאומיים, מרצה באוניברסיטת תל אביב ומובילה חידושים בתחום האונקולוגיה.",
  aboutSectionText3: "היא ידועה בגישתה האנושית והאמפתית, המשלבת מקצועיות עם יחס אישי למטופליה. היא חברה באיגודים מקצועיים מובילים, כולל ESMO והאיגוד הישראלי לאונקולוגיה קלינית.",
  readFullBio: "קרא את הביוגרפיה המלאה",
  yearsExperience: "30+ שנות ניסיון",
  // biographyText1: "ד\"ר ויקטוריה ניימן היא מומחית מובילה באונקולוגיה קלינית, רפואה פנימית ורדיותרפיה, עם ניסיון של למעלה מ-30 שנה. היא מנהלת את מחלקת האשפוז האונקולוגי במרכז דוידוף לסרטן שבמרכז הרפואי רבין.",
  // biographyText2: "התמחותה מתמקדת בגידולים אורו-אונקולוגיים, כולל סרטן כליה, ערמונית, שלפוחית השתן ואשכים, וכן בסרטן השד. ד\"ר ניימן פעילה במחקרים קליניים בינלאומיים, מרצה באוניברסיטת תל אביב ומובילה חידושים בתחום האונקולוגיה.",
  // biographyText3: "היא ידועה בגישתה האנושית והאמפתית, המשלבת מקצועיות עם יחס אישי למטופליה. היא חברה באיגודים מקצועיים מובילים, כולל ESMO והאיגוד הישראלי לאונקולוגיה קלינית.",
  ...
  cancerInElderlyDesc:
    "גישות מיוחדות לטיפול בסרטן בחולים גריאטריים, באיזון בין יילות ואיכות חיים.",
  ...
  // Biography Section
  professionalBiography: "ביוגרפיה מקצועית",
  biographyText1: "ד\"ר ויקטוריה ניימן היא מומחית מובילה באונקולוגיה קלינית, רפואה פנימית ורדיותרפיה, עם ניסיון של למעלה מ-30 שנה. היא מנהלת את מחלקת האשפוז האונקולוגי במרכז דוידוף לסרטן, חלק מהמרכז הרפואי רבין (בילינסון).",
  biographyText2: "תחומי ההתמחות שלה כוללים רפואה פנימית, אונקולוגיה קלינית ורדיותרפיה, עם התמקדות מיוחדת בגידולים אורו-אונקולוגיים וסרטן השד. היא מטפלת במגוון רחב של מחלות, כולל סרטן הכליה, הערמונית, שלפוחית השתן והאשכים.",
  biographyText3: "ד\"ר ניימן סיימה את לימודי הרפואה באוניברסיטה בברית המועצות, והתמחתה ברפואה פנימית, אונקולוגיה קלינית ורדיותרפיה במרכז הרפואי רבין. היא מרצה בבית הספר לרפואה ע\"ש סאקלר באוניברסיטת תל אביב ובבית הספר לאחיות.",
  biographyText4: "היא פעילה במחקרים קליניים רבים, כולל מחקרים בינלאומיים בנושאי סרטן השד, הכליה, מערכת השתן והערמונית. מחקריה תורמים לקידום הטיפול האונקולוגי ולהבנת המחלה.",
  biographyText5: "ד\"ר ניימן חברה באיגודים מקצועיים מובילים, כולל האיגוד לאונקולוגיה קלינית ורדיותרפיה, האיגוד הישראלי לרפואה פנימית, איגוד האורולוגים הישראלי והחברה האירופית לאונקולוגיה רפואית (ESMO).",
  biographyText6: "מטופליה מציינים את מקצועיותה, האנושיות והזמינות הרבה שלה.",
  ...
  biographyText10: "גישתה לטיפול במטופלים משלבת מומחיות רפואית מתקדמת עם חמלה עמוקה, תוך הבטחת טיפול מותאם אישית לצרכים ולנסיבות הספציפיות של כל מטופל.",
};
