export const heTranslations = {
  ...
  aboutSectionText2: "התמחותה מתמקדת בגידולים אורו-אונקולוגיים, כולל סרטן כליה, ערמונית, שלפוחית השתן ואשכים, וכן בסרטן השד. ד\"ר ניימן פעילה במחקרים קליניים בינלאומיים, מרצה באוניבר��יטת תל אביב ומובילה חידושים בתחום האונקולוגיה.",
  ...
  cancerInElderlyDesc:
    "גישות מיוחדות לטיפול בסרטן בחולים גריאטריים, באיזון בין יילות ואיכות ��יים.",
  ...
  editContactInfo: "עריכת פרטי יצירת קשר",
  addContactInfo: "הוספת פרטי יצירת קשר",
  typeLabel: "סוג",
  valueLabel: "ערך",
  orderLabel: "סדר",
  iconLabel: "אייקון",
