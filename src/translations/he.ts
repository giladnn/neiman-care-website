export const heTranslations = {
  ...
  officePhone: "טלפון",
  officeEmail: "דוא\"ל",
  officeHours: "שעות קבלה",
  messageSent: "הודעתך נשלחה! נחזור אליך בהקדם.",
  errorSending: "שגיאה בשליחת ההודעה",
  enterValidEmail: "אנא הכנס כתובת דוא\"ל תקינה.",
  enterValidPhone: "אנא הכנס מספר טלפון תקין.",
  nameRequired: "נדרש למלא שם",
  subjectRequired: "נדרש למלא נושא",
  messageRequired: "נדרש למלא הודעה",
  frequently: "שאלות נפוצות",
  appointmentQuestion: "כיצד ניתן לקבוע תור?",
  appointmentAnswer: "ניתן לקבוע תור על ידי התקשרות למשרד, שימוש בטופס הזמנת תור באינטרנט, או שליחת דוא\"ל.",
  referralQuestion: "האם אני זקוק להפניה?",
  referralAnswer: "למרות שהפניה מרופא המשפחה מועילה, היא לא תמיד נדרשת. אנא צור קשר עם המשרד שלנו כדי לדון במצב הספציפי שלך.",
